...
const fieldLabels: Record<ValidationLanguage, Record<string, string>> = {
  de: {
    ...
    country: "Land",
    currency: "Währung",
    debtorCity: "Ort des Zahlenden",
    debtorCountry: "Land des Zahlenden",
    debtorName: "Name des Zahlenden",
    debtorNumber: "Nummer des Zahlenden",
    debtorPostcode: "PLZ des Zahlenden",
    debtorStreet: "Strasse des Zahlenden",
    iban: "IBAN",
    input: "Eingabe",
    message: "Mitteilung",
  ...
  en: {
    ...
    country: "Country",
    currency: "Currency",
    debtorCity: "Payable by city",
    debtorCountry: "Payable by country",
    debtorName: "Payable by name",
    debtorNumber: "Payable by number",
    debtorPostcode: "Payable by postcode",
    debtorStreet: "Payable by street",
    iban: "IBAN",
    input: "Input",
    message: "Message",
    name: "Payee name",
